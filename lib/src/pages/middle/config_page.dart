  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        const Texto(txt: 'ACCIONES Y CONFIGURACIONES', sz: 13, txtC: Colors.green),
        s10,
        _iteMenu(context, icon: Icons.home, label: 'Portada', secc: 'home'),
        s10,
        const Divider(),
        _iteMenu(context, icon: Icons.shopify_outlined, label: 'Solicitar NUEVA Cotización', secc: 'cotiza'),
        const Divider(),
        _iteMenu(context, icon: Icons.fact_check_outlined, label: 'Órdenes para RASTREAR', secc: 'soliOk'),
        s10,
        _iteMenu(context, icon: Icons.dvr_outlined, label: 'Órdenes en PROCESO', secc: 'almacenVirtual'),
        s10,
        const Divider(),
        ...
        if(isAdmin)
          ...[
            s10,
            const Texto(txt: 'ADMINISTRACIÓN', sz: 13, txtC: Colors.green),
            s10,
            _iteMenu(context, icon: Icons.not_listed_location_outlined, label: 'ASIGNAR Nuevas Órdenes', secc: 'soliNon'),
            s10,
